    ...
    return (
        <div className="card">
            <div className="card--stats">
                ...
                <React.Fragment>
                    ...
                    <div className="row">
                        <img
                            ...
                            alt="calorie icon"
                        />
                        <span>{new Intl.NumberFormat().format(props.calories.toFixed(0))} cal</span>
                        <img
                            className="card--icon"
                ...
                <button className="card-btn"><Link to={props.url} className="card-btn-link">Go to Recipe</Link></button>
                </React.Fragment>
            )}
            </div>
        </div>
